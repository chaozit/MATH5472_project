XMAP <- function(X1, X2, y1, y2, K = 10, K1 = 0, K2 = 0, Sigma1, Sigma2, rho, Eta1 = NULL, Eta2 = NULL, Omega, Sig_E1, Sig_E2, prior_weights, prior_weights1 = NULL, prior_weights2 = NULL, maxIter = 1000, tol = 5e-6, estimate_prior_variance = T, estimate_residual_variance = T, estimate_background_variance = F, initialize = F) {
  n1 <- nrow(X1)
  n2 <- nrow(X2)
  n <- n1 + n2
